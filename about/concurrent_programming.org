...
locks etc. The [[file:xref/../../reference/refs.xml][software
...
[[file:xref/../../reference/agents.xml][agent]] system supports sharing
changing state between threads in an /asynchronous/ and /independent/
manner. The [[file:xref/../../reference/atoms.xml][atoms]] system
supports sharing changing state between threads in a /synchronous/ and
/independent/ manner. The [[file:xref/../../reference/vars.xml][dynamic
...
[[file:xref/../../reference/refs.xml][Refs]] are mutable references to
objects. They can be
[[https://clojure.github.io/clojure/clojure.core-api.html#clojure.core/ref-set][ref-set]]
or
...
with [[file:xref/../../reference/metadata.xml][metadata]] mark them as
dynamic. [[file:xref/../../reference/vars.xml][Dynamic vars]] are also
