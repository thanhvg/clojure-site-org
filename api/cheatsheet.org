...
** Clojure 1.10 Cheat Sheet (v49)
   ...
   :END:
[[https://github.com/jafingerhut/clojure-cheatsheets/blob/master/pdf/cheatsheet-usletter-color.pdf?raw=true][Download
PDF version]] / [[https://jafingerhut.github.io/][Source repo]]
...
| Test     | =fn? ifn?=                                                                                                         |
** Abstractions
([[https://github.com/cemerick/clojure-type-selection-flowchart][Clojure
...
** Special Characters
([[https://clojure.org/reference/reader#macrochars][clojure.org/reference/reader]],
[[https://clojure.org/guides/weird_characters][guide]])
   :PROPERTIES:
...
| =#_=              | Ignore next form                                                                                                                                 |
** Metadata
([[https://clojure.org/reference/reader#_metadata][clojure.org/reference/reader]],
[[https://clojure.org/reference/special_forms][special\_forms]])
   :PROPERTIES:
...
** Special Forms
([[https://clojure.org/reference/special_forms][clojure.org/reference/special\_forms]])
   :PROPERTIES:
...
** Java Interoperation
([[https://clojure.org/reference/java_interop][clojure.org/reference/java\_interop]])
   :PROPERTIES:
