...
*** =gen/one-of=
    :PROPERTIES:
    :CUSTOM_ID: __literal_gen_one_of_literal
    :END:
...
*** =gen/such-that=
    :PROPERTIES:
    :CUSTOM_ID: __literal_gen_such_that_literal
    :END:
...
*** =gen/fmap=
    :PROPERTIES:
    :CUSTOM_ID: __literal_gen_fmap_literal
    :END:
...
*** =gen/bind=
    :PROPERTIES:
    :CUSTOM_ID: __literal_gen_bind_literal
    :END:
...
** =quick-check=
   :PROPERTIES:
   :CUSTOM_ID: __literal_quick_check_literal
   :END:
...
** =defspec=
   :PROPERTIES:
   :CUSTOM_ID: __literal_defspec_literal
   :END:
...
For example, the [[quick-check-examples][first =quick-check= example in
this guide]] could also be written like this:
...
[[https://github.com/clojure/test.check/blob/master/README.md][test.check
README]].
