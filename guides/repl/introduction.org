...
[[file:xref/../../learn/syntax.xml][basic understanding]] of Clojure,
...
-  If you are */just starting to learn Clojure/*, the first 2 chapters
   [[file:launching_a_basic_repl.xml][Launching a basic Clojure REPL]]
   and [[file:basic_usage.xml][Basic Usage]] are enough to get you
...
-  As soon as you start */developing non-trivial programs/* (such as a
   ...
   next 2 chapters: [[file:data_visualization_at_the_repl.xml][Data
   visualization at the REPL]] and
   [[file:navigating_namespaces.xml][Navigating namespaces]].

-  For */working on Clojure projects at a professional level/*,
   [[file:enhancing_your_repl_workflow.xml][Enhancing your REPL
   workflow]] and
   [[file:guidelines_for_repl_aided_development.xml][Guidelines for
   REPL-Aided Development]] are must-reads.

First, we'll learn how to [[file:launching_a_basic_repl.xml][launch a
basic Clojure REPL]].
