...
-  When using non-Clojure collections in a Clojure hash-based collection
   ...
   collection with Clojure counterparts, due to the difference in
   hashing behavior. (see
   [[file:xref/../equality.xml#equality_and_hash][Equality and hash]]
   and [[https://clojure.atlassian.net/browse/CLJ-1372][CLJ-1372]])
...
** Other cases of =hash= inconsistent with ===
   :PROPERTIES:
   :CUSTOM_ID: _other_cases_of_literal_hash_literal_inconsistent_with_literal_literal
   :END:
...
The paper
[[http://home.pipeline.com/~hbaker1/ObjectIdentity.html]["Equal Rights
for Functional Objects, or, the More Things Change, The More They Are
