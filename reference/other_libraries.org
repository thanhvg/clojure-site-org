...
[[https://clojure.github.io/clojure/clojure.java.javadoc-api.html#clojure.java.javadoc/javadoc][javadoc]]
that attempts to display the appropriate Javadocs for a class or
instance class.

*[[https://clojure.github.io/clojure/clojure.java.shell-api.html][clojure.java.shell]]*

Provides a
[[https://clojure.github.io/clojure/clojure.java.shell-api.html#clojure.java.shell/sh][sh]]
...
([[https://clojure.github.io/clojure/clojure.reflect-api.html][clojure.reflect]])
  :PROPERTIES:
  :CUSTOM_ID: _reflection_utilities_link_xl_href_https_clojure_github_io_clojure_clojure_reflect_api_html_clojure_reflect_link
  :END:
...
([[https://clojure.github.io/clojure/clojure.repl-api.html][clojure.repl]])
  :PROPERTIES:
  :CUSTOM_ID: _repl_utilities_link_xl_href_https_clojure_github_io_clojure_clojure_repl_api_html_clojure_repl_link
  :END:
...
([[https://clojure.github.io/clojure/clojure.set-api.html][clojure.set]])
  :PROPERTIES:
  :CUSTOM_ID: _sets_and_relational_algebra_link_xl_href_https_clojure_github_io_clojure_clojure_set_api_html_clojure_set_link
  :END:
...
([[https://clojure.github.io/clojure/clojure.string-api.html][clojure.string]])
  :PROPERTIES:
  :CUSTOM_ID: _string_handling_link_xl_href_https_clojure_github_io_clojure_clojure_string_api_html_clojure_string_link
  :END:
...
([[https://clojure.github.io/clojure/clojure.test-api.html][clojure.test]])
  :PROPERTIES:
  :CUSTOM_ID: _unit_testing_link_xl_href_https_clojure_github_io_clojure_clojure_test_api_html_clojure_test_link
  :END:
...
([[https://clojure.github.io/clojure/clojure.walk-api.html][clojure.walk]])
  :PROPERTIES:
  :CUSTOM_ID: _walking_data_structures_link_xl_href_https_clojure_github_io_clojure_clojure_walk_api_html_clojure_walk_link
  :END:
...
([[https://clojure.github.io/clojure/clojure.xml-api.html][clojure.xml]])
  :PROPERTIES:
  :CUSTOM_ID: _xml_link_xl_href_https_clojure_github_io_clojure_clojure_xml_api_html_clojure_xml_link
  :END:
...
([[https://clojure.github.io/clojure/clojure.zip-api.html][clojure.zip]])
  :PROPERTIES:
  :CUSTOM_ID: _zippers_functional_tree_editing_link_xl_href_https_clojure_github_io_clojure_clojure_zip_api_html_clojure_zip_link
  :END:
...
background, see the
[[https://www.google.com/search?q=huet%20functional%20zipper][paper by
Huet]]. A zipper is a data structure representing a location in a
hierarchical data structure, and the path it took to get there. It
provides down/up/left/right navigation, and localized functional
'editing', insertion and removal of nodes. With zippers you can write
code that looks like an imperative, destructive walk through a tree,
call
[[https://clojure.github.io/clojure/clojure.zip-api.html#clojure.zip/root][root]]
...
[[https://clojure.github.io/clojure/clojure.zip-api.html#clojure.zip/next][next]]
