...
Looping (see also [[file:sequences.xml][Sequences]]):
...
Working with vars (see also [[file:vars.xml][Vars and Environment]]):
...
Dynamic scopes (see also [[file:vars.xml][Vars and Environment]]):
...
Creating lazy things (see also [[file:sequences.xml][Sequences]]):
...
[[file:java_interop.xml][Java interop]] macros:
[[https://clojure.github.io/clojure/clojure.core-api.html#clojure.core/%2E%2E][..]]
...
A few [[file:special_forms.xml][special forms]] are actually implemented
