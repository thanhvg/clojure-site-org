...
-  Each file generates a loader class of the same name with "\_\_init"
   appended.
...
-  A stand-alone
   ...
   facility is provided for generating named interface classes for
   direct use as Java interfaces, with facilities for:
